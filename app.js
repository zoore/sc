...
function initStartScreen() {
    ...
    })), background = new Elements.Background(assetLib.getData("mainBackground"), canvas.width, canvas.height), userInput.addHitArea("mute", butEventHandler, null, "rect", {aRect: [644, 0, canvas.width, 54]}, !0);
    var a = {
        oImgData: assetLib.getData("uiButs"),
        aPos: [620, 340],
        id: "play"
    }, b = {oImgData: assetLib.getData("uiButs"), aPos: [98, 359], id: "credits"};
    userInput.addHitArea("showMapScreen", butEventHandler, null, "image", a), userInput.addHitArea("credits", butEventHandler, null, "image", b);
    var c = new Array(a, b);
    panel = new Elements.Panel(assetLib.getData("panels"), assetLib.getData("uiElements"), assetLib.getData("position"), assetLib.getData("numbers"), gameState, c, canvas.width, canvas.height), panel.startTween1(), previousTime = (new Date).getTime(), updateStartScreenEvent()
}
...
function initMapScreen() {
    ...
    var a = {
        ...
        aPos: [61, 359],
        id: "back"
    }, c = {oImgData: assetLib.getData("uiButs"), aPos: [165, 359], id: "resetScores"};
    userInput.addHitArea("startGame", butEventHandler, null, "image", a), userInput.addHitArea("backFromMap", butEventHandler, null, "image", b), userInput.addHitArea("resetScores", butEventHandler, null, "image", c);
    var d = new Array(a, b, c), e = aMapPointData[8][0], f = aMapPointData[8][1];
...
function setNewCurve(a) {
    ...
    1 * Math.random() > .5 && speed > 400 && (b = 2 * Math.random() - 1), "forest" == levelTheme ? a.curveTween = TweenMax.to(a, 2 * Math.random() + 4, {
        curveAmount: b,
        ease: "Cubic.easeInOut",
        onComplete: setNewCurve,
        onCompleteParams: [a]
...
function butEventHandler(a, b) {
    switch (a) {
        case"langSelect":
            ...
            break;
        case"showMapScreen":
            playSound("click"), userInput.removeHitArea("showMapScreen"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), initMapScreen();
            break;
        case"credits":
            playSound("click"), userInput.removeHitArea("showMapScreen"), userInput.removeHitArea("moreGames"), userInput.removeHitArea("credits"), initCreditsScreen();
            break;
        ...
        case"moreGamesPause":
            break;
        case"startGame":
            playSound("click"), userInput.removeHitArea("startGame"), userInput.removeHitArea("backFromMap"), userInput.removeHitArea("resetScores"), userInput.removeHitArea("selectLevel"), initGame();
            break;
        case"backFromMap":
            playSound("click"), userInput.removeHitArea("startGame"), userInput.removeHitArea("backFromMap"), userInput.removeHitArea("resetScores"), userInput.removeHitArea("selectLevel"), initStartScreen();
            break;
        case"selectLevel":
            playSound("click"), panel.highlight.x = aMapPointData[b.id][0], panel.highlight.y = aMapPointData[b.id][1], levelNum = b.id, levelTheme = "city", 3 > levelNum ? levelTheme = "forest" : levelNum > 5 && (levelTheme = "desert");
            break;
        case"resetScores":
            playSound("click"), saveDataHandler.clearData(), saveDataHandler.saveData(), userInput.removeHitArea("startGame"), userInput.removeHitArea("backFromMap"), userInput.removeHitArea("resetScores"), userInput.removeHitArea("selectLevel"), initMapScreen();
            break;
        case"steerLeft":
        ...
        case"quitFromLevelEnd":
            playSound("click"), userInput.removeHitArea("quitFromLevelEnd"), userInput.removeHitArea("upgradeScreen"), initStartScreen();
            break;
        case"upgradeScreen":
            playSound("click"), userInput.removeHitArea("quitFromLevelEnd"), userInput.removeHitArea("upgradeScreen"), initUpgradeScreen();
            break;
        case"powerUp0":
        ...
        case"nextFromUpgrades":
            playSound("click"), userInput.removeHitArea("nextFromUpgrades"), userInput.removeHitArea("quitFromUpgrades"), userInput.removeHitArea("powerUp0"), userInput.removeHitArea("powerUp1"), userInput.removeHitArea("powerUp2"), userInput.removeHitArea("powerUp3"), initMapScreen();
            break;
        case"quitFromUpgrades":
            playSound("click"), userInput.removeHitArea("nextFromUpgrades"), userInput.removeHitArea("quitFromUpgrades"), userInput.removeHitArea("powerUp0"), userInput.removeHitArea("powerUp1"), userInput.removeHitArea("powerUp2"), userInput.removeHitArea("powerUp3"), initStartScreen();
            break;
        case"mute":
        ...
        case"resumeFromPause":
            ...
            break;
        case"quitFromPause":
            playSound("click"), toggleManualPause(), userInput.removeHitArea("pause"), userInput.removeHitArea("steerLeft"), userInput.removeHitArea("steerRight"), userInput.removeHitArea("steerRight"), userInput.removeHitArea("steerLeft"), userInput.removeHitArea("quitFromPause"), userInput.removeHitArea("resumeFromPause"), userInput.removeHitArea("moreGamesPause"), curveTween.kill(), hillTween.kill(), levelScore = 0, initStartScreen()
    }
}
function initLevelComplete() {
    alert("本局得分：" + levelScore + "  关卡：" + melevel);
    gameState = "levelComplete", 1 == audioType && (musicTween.kill(), musicTween = TweenLite.to(music, 2, {
        volume: .2,
        ease: "Linear.easeNone"
    })), curveTween.kill(), hillTween.kill(), background = new Elements.Background(assetLib.getData("finishBackground"), canvas.width, canvas.height), userInput.removeHitArea("pause"), userInput.removeHitArea("steerLeft"), userInput.removeHitArea("steerRight");
    var a = {
        oImgData: assetLib.getData("uiButs"),
        aPos: [620, 340],
        id: "play"
    }, b = {oImgData: assetLib.getData("uiButs"), aPos: [98, 359], id: "quit"};
    userInput.addHitArea("upgradeScreen", butEventHandler, null, "image", a), userInput.addHitArea("quitFromLevelEnd", butEventHandler, null, "image", b);
    var c = new Array(a, b);
    panel = new Elements.Panel(assetLib.getData("panels"), assetLib.getData("uiElements"), assetLib.getData("position"), assetLib.getData("numbers"), gameState, c, canvas.width, canvas.height), panel.startTween1(), levelScore += 50, levelScore += 300 * (levelNum + 1), levelScore += 200 * (20 - racePos), 2 == racePos ? levelScore += 250 : 1 == racePos ? levelScore += 500 : 0 == racePos && (levelScore += 1e3), levelScore = Math.max(levelScore, 100), totalScore += levelScore, winnings += Math.round(levelScore / 10), panel.oScoreData = {
        racePos: racePos,
        winnings: Math.round(levelScore / 10),
        levelScore: levelScore,
        totalScore: totalScore
    }, saveDataHandler.aLevelStore[3 * levelNum] = 2, saveDataHandler.aLevelStore[3 * levelNum + 1] > racePos && (saveDataHandler.aLevelStore[3 * levelNum + 1] = racePos), saveDataHandler.aLevelStore[3 * levelNum + 2] < levelScore && (saveDataHandler.aLevelStore[3 * levelNum + 2] = levelScore), saveDataHandler.aLevelStore[31] = winnings, 8 > levelNum && 0 == saveDataHandler.aLevelStore[3 * (levelNum + 1)] && (saveDataHandler.aLevelStore[3 * (levelNum + 1)] = 1), saveDataHandler.saveData(), previousTime = (new Date).getTime(), updateLevelComplete();
    loadmeover();
...
function initUpgradeScreen() {
    gameState = "upgrade", background = new Elements.Background(assetLib.getData("upgradeBackground"), canvas.width, canvas.height);
    var a = {
        oImgData: assetLib.getData("uiButs"),
        aPos: [620, 340],
        id: "play"
    ...
    userInput.addHitArea("nextFromUpgrades", butEventHandler, null, "image", a), userInput.addHitArea("quitFromUpgrades", butEventHandler, null, "image", b), userInput.addHitArea("powerUp0", butEventHandler, null, "image", c), userInput.addHitArea("powerUp1", butEventHandler, null, "image", d), userInput.addHitArea("powerUp2", butEventHandler, null, "image", e), userInput.addHitArea("powerUp3", butEventHandler, null, "image", f);
    var g = new Array(c, d, e, f, a, b);
    panel = new Elements.Panel(assetLib.getData("panels"), assetLib.getData("uiElements"), assetLib.getData("position"), assetLib.getData("numbers"), gameState, g, canvas.width, canvas.height), setPowerUpButs(), panel.startTween1(), panel.oScoreData = {
        winnings: winnings,
        totalScore: totalScore,
        aPowerUpBarData: aPowerUpBarData
...
function setPowerUpButs() {
    panel.aButs[0].id = aPowerUpButsData[aPowerUpBarData[0]] > winnings || aPowerUpBarData[0] >= 8 ? "cost" + aPowerUpButsData[aPowerUpBarData[0]] + "Off" : "cost" + aPowerUpButsData[aPowerUpBarData[0]] + "On", panel.aButs[1].id = aPowerUpButsData[aPowerUpBarData[1]] > winnings || aPowerUpBarData[1] >= 8 ? "cost" + aPowerUpButsData[aPowerUpBarData[1]] + "Off" : "cost" + aPowerUpButsData[aPowerUpBarData[1]] + "On", panel.aButs[2].id = aPowerUpButsData[aPowerUpBarData[2]] > winnings || aPowerUpBarData[2] >= 8 ? "cost" + aPowerUpButsData[aPowerUpBarData[2]] + "Off" : "cost" + aPowerUpButsData[aPowerUpBarData[2]] + "On", panel.aButs[3].id = aPowerUpButsData[aPowerUpBarData[3]] > winnings || aPowerUpBarData[3] >= 8 ? "cost" + aPowerUpButsData[aPowerUpBarData[3]] + "Off" : "cost" + aPowerUpButsData[aPowerUpBarData[3]] + "On"
}
function roadCallback(a, b) {
    switch ("undefined" == typeof b && (b = null), a) {
        case"hitEnemyCar":
            nitroMode && (speed = maxSpeed, nitroMode = !1), speed *= .75, steerX += 1e3 * b.bounceX, 4 >= startTimer && (levelScore -= 100), playSound("crash" + Math.ceil(3 * Math.random()));
            break;
        case"hitNitro":
            nitroMode = !0, setNewCurve(this), nitroTimer = 0, playSound("nitroStart"), 4 >= startTimer && (levelScore += 500)
    }
}
function updateGameEvent() {
    if (!manualPause && !rotatePause && "game" == gameState) {
        ...
        if (road.steerX > 500 / road.roadScaleMultiplier || road.steerX < -500 / road.roadScaleMultiplier ? (speed = Math.max(speed -= 250 * a, 200), 4 >= startTimer && (levelScore -= Math.round(25 * a)), offRoad || (playSound("offRoad"), offRoad = !0)) : (offRoad = !1, nitroMode ? (flexMaxSpeed = nitroSpeed - Math.abs(steerX) / 4, speed += a * ((flexMaxSpeed - speed) / 3), nitroTimer += a, nitroTimer > nitroLength && (nitroMode = !1, playSound("nitroEnd"))) : (flexMaxSpeed = maxSpeed - Math.abs(steerX) / (3 + turnRate), speed += a * ((flexMaxSpeed - speed) / accRate))), hud.speed = Math.round(speed / 4), raceProgress += speed * a, leadProgress += enemySpeed * a, hud.raceProgress = raceProgress / raceLength, carReleaseDelay += speed * a, raceProgress > raceLength ? (road.bridgeType = 5, road.bridgeRow = 0, hud.raceProgress = 1) : raceProgress > bridgeDistanceTarg && (road.bridgeType = 4, road.bridgeRow = 0, bridgeDistanceTarg += raceLength / 4), carReleasedNum > 0 && road.freeToAddCar() && raceProgress > leadProgress - carReleasedNum / 19 * .9 * leadProgress && (road.addEnemyCar(), carReleasedNum--, overtakenInc = 1, carReleaseDelay = 0), 19 > racePos && enemySpeed > speed ? (speedDifferencial += enemySpeed - speed, speedDifferencial > 5e3 * overtakenInc && (overtakenInc++, road.addEnemyCar(!1), 4 >= startTimer && (racePos++, playSound("undertake")), speedDifferencial = 0)) : speedDifferencial = 0, tweenScaleTimer += a, tweenScaleTimer > .5 && (tweenScaleTimer = 0, curveTween.timeScale = hillTween.timeScale = speed * speed * speed / (maxSpeed * maxSpeed * maxSpeed)), targSteerX = rightSteer + leftSteer + curveAmount * speed * (1.3 + (.96 - turnRate / 5)), steerX += (targSteerX - steerX) * turnRate * a, !justSkid && (steerX > 525 || -525 > steerX) ? (playSound("skid" + Math.ceil(3 * Math.random())), justSkid = !0) : steerX > -100 && 100 > steerX && (justSkid = !1), road.update(speed, steerX, curveAmount, hillAmount, a), road.render(ctx), userCar.update(speed, steerX, curveAmount, hillAmount, rightSteerSimple + leftSteerSimple, a), userCar.render(ctx), hud.render(ctx), firstPlay) {
            var b = assetLib.getData("uiElements"), c = "tutorial0";
            0 == Math.floor(startTimer) % 2 && (c = "tutorial1");
            var d = b.oData.oAtlasData[c].x, e = b.oData.oAtlasData[c].y, f = b.oData.oAtlasData[c].width, g = b.oData.oAtlasData[c].height;
            ctx.drawImage(b.img, d, e, f, g, 0, 70, f, g), startTimer += a, startTimer > 4 && (firstPlay = !1, playSound("start2"), startTimer = 4)
            ...
            var d = b.oData.oAtlasData["start" + Math.floor(2 * startTimer)].x, e = b.oData.oAtlasData["start" + Math.floor(2 * startTimer)].y, f = b.oData.oAtlasData["start" + Math.floor(2 * startTimer)].width, g = b.oData.oAtlasData["start" + Math.floor(2 * startTimer)].height;
            ctx.drawImage(b.img, d, e, f, g, canvas.width / 2 - f / 2, 75, f, g), startTimer += a, startTimer >= 2 && (setNewCurve(this), setNewHill(this), startTimer = 4)
        } else if (1 == hud.raceProgress) {
            var b = assetLib.getData("uiElements"), d = b.oData.oAtlasData.finish.x, e = b.oData.oAtlasData.finish.y, f = b.oData.oAtlasData.finish.width, g = b.oData.oAtlasData.finish.height;
            ctx.drawImage(b.img, d, e, f, g, canvas.width / 2 - f / 2, 100 + 10 * Math.sin(10 * startTimer), f, g), startTimer += a, endSoundPlayed || (playSound("raceEnd"), endSoundPlayed = !0), startTimer > 8 && initLevelComplete()
        }
...
function updateLevelComplete() {
    if (!rotatePause && "levelComplete" == gameState) {
        var a = getDelta();
        background.updateScroll(a), background.renderScroll(ctx), panel.update(a), panel.render(ctx), renderMuteBut(), requestAnimFrame(updateLevelComplete)
    }
}
function updateUpgradeScreen() {
    if (!rotatePause && "upgrade" == gameState) {
        var a = getDelta();
        background.render(ctx), panel.update(a), panel.render(ctx), renderMuteBut(), requestAnimFrame(updateUpgradeScreen)
    }
}
...
function updateStartScreenEvent() {
    if (!rotatePause && "start" == gameState) {
        var a = getDelta();
        background.updateScroll(a), background.renderScroll(ctx), panel.update(a), panel.render(ctx), renderMuteBut(), requestAnimFrame(updateStartScreenEvent)
    }
}
function updateMapEvent() {
    if (!rotatePause && "map" == gameState) {
        var a = getDelta();
        background.updateScroll(a), background.renderScroll(ctx), panel.update(a), panel.render(ctx), renderMuteBut(), requestAnimFrame(updateMapEvent)
    }
}
function getDelta() {
...
function checkSpriteCollision(a, b) {
    var c = a.x, d = a.y, e = b.x, f = b.y, g = (c - e) * (c - e) + (d - f) * (d - f), h = a.radius * b.radius;
    return h > g ? !0 : !1
}
...
function initLangSelect() {
    ...
    for (var b = 140, c = 0; c < aLangs.length; c++) {
        ...
        userInput.addHitArea("langSelect", butEventHandler, {lang: aLangs[c]}, "rect", {aRect: [d, e, d + b, e + 140]})
    }
}
...
function loadAssets() {
    ...
    }, {id: "finishBackground", file: "images/finishBackground.jpg"}, {
    ...
    }, {id: "numbers", file: "images/numbers_41x47.png"}, {
        id: "forestRoad",
        file: "images/forestRoad.jpg"
    }, {id: "cityRoad", file: "images/cityRoad.jpg"}, {
        id: "desertRoad",
        file: "images/desertRoad.jpg"
    }, {id: "forestSkyline", file: "images/forestSkyline.jpg"}, {
        id: "forestGround",
        file: "images/forestGround.jpg"
    }, {id: "forestFog", file: "images/forestFog.png"}, {
        id: "citySkyline",
        file: "images/citySkyline.jpg"
    }, {id: "cityGround", file: "images/cityGround.jpg"}, {
        id: "cityFog",
        file: "images/cityFog.png"
    }, {id: "desertSkyline", file: "images/desertSkyline.jpg"}, {
        id: "desertGround",
        file: "images/desertGround.jpg"
    }, {id: "desertFog", file: "images/desertFog.png"}, {id: "hud", file: "images/hud_700x400.png"}, {
        id: "uiButs",
        file: "images/" + curLang + "/uiButs.png",
        oAtlasData: {
            play: {x: 0, y: 258, width: 167, height: 123},
            credits: {x: 0, y: 0, width: 186, height: 84},
            moreGames: {x: 0, y: 86, width: 186, height: 84},
            back: {x: 169, y: 258, width: 111, height: 86},
            quit: {x: 0, y: 172, width: 186, height: 84},
            cost100On: {x: 282, y: 242, width: 95, height: 75},
            cost250On: {x: 188, y: 165, width: 95, height: 75},
            cost500On: {x: 282, y: 319, width: 95, height: 75},
            cost1000On: {x: 188, y: 88, width: 95, height: 75},
            resetScores: {x: 188, y: 0, width: 111, height: 86},
            cost100Off: {x: 285, y: 88, width: 93, height: 73},
            cost250Off: {x: 169, y: 346, width: 93, height: 73},
            cost500Off: {x: 301, y: 0, width: 93, height: 73},
            cost1000Off: {x: 285, y: 163, width: 93, height: 73}
        }
    }, {
        id: "scenery",
        file: "images/scenery.png",
        oAtlasData: {
            forest0: {x: 529, y: 286, width: 201, height: 244},
            forest1: {x: 696, y: 0, width: 118, height: 223},
            forest2: {x: 0, y: 780, width: 154, height: 87},
            nitro: {x: 294, y: 780, width: 109, height: 111},
            city0: {x: 528, y: 542, width: 204, height: 204},
            city1: {x: 156, y: 780, width: 136, height: 112},
            city2: {x: 734, y: 414, width: 102, height: 214},
            desert0: {x: 732, y: 225, width: 117, height: 187},
            desert1: {x: 734, y: 630, width: 98, height: 226},
            desert2: {x: 528, y: 748, width: 173, height: 125},
            start: {x: 0, y: 542, width: 526, height: 236},
            finish: {x: 0, y: 286, width: 527, height: 254},
            bridge: {x: 0, y: 0, width: 694, height: 284}
        }
    }, {
        id: "uiElements",
        file: "images/" + curLang + "/uiElements.png",
        oAtlasData: {
            needle: {x: 398, y: 664, width: 66, height: 24},
            helmet: {x: 704, y: 717, width: 38, height: 35},
            completedLevel: {x: 702, y: 211, width: 92, height: 93},
            forest: {x: 594, y: 664, width: 108, height: 109},
            city: {x: 702, y: 0, width: 108, height: 109},
            desert: {x: 596, y: 528, width: 108, height: 109},
            levelHighlight: {x: 702, y: 111, width: 98, height: 98},
            finish: {x: 0, y: 528, width: 396, height: 163},
            start0: {x: 396, y: 693, width: 196, height: 134},
            start1: {x: 198, y: 693, width: 196, height: 134},
            start2: {x: 398, y: 528, width: 196, height: 134},
            start3: {x: 0, y: 693, width: 196, height: 134},
            tutorial0: {x: 0, y: 0, width: 700, height: 262},
            tutorial1: {x: 0, y: 264, width: 700, height: 262},
            upgrade0: {x: 704, y: 679, width: 77, height: 36},
            upgrade1: {x: 702, y: 386, width: 78, height: 38},
            upgrade2: {x: 702, y: 426, width: 78, height: 38},
            upgrade3: {x: 702, y: 306, width: 78, height: 38},
            upgrade4: {x: 702, y: 466, width: 78, height: 38},
            upgrade5: {x: 704, y: 639, width: 78, height: 38},
            upgrade6: {x: 675, y: 775, width: 78, height: 38},
            upgrade7: {x: 702, y: 346, width: 78, height: 38},
            upgrade8: {x: 594, y: 775, width: 79, height: 38}
        }
    }, {id: "panels", file: "images/" + curLang + "/panels_700x400.png"}, {
        id: "position",
        file: "images/position_58x42.png"
    }, {id: "muteBut", file: "images/mute_55x55.png"}, {
        id: "userCar",
...
function toggleManualPause() {
    if (manualPause)manualPause = !1, userInput.removeHitArea("quitFromPause"), userInput.removeHitArea("resumeFromPause"), userInput.removeHitArea("moreGamesPause"), pauseCoreOff(); else {
        ...
        userInput.addHitArea("quitFromPause", butEventHandler, null, "image", a), userInput.addHitArea("resumeFromPause", butEventHandler, null, "image", b), panel = new Elements.Panel(assetLib.getData("panels"), assetLib.getData("uiElements"), assetLib.getData("position"), assetLib.getData("numbers"), "pause", c, canvas.width, canvas.height), panel.render(ctx), userInput.addHitArea("pause", butEventHandler, null, "rect", {aRect: [587, 0, 635, 54]}, !0)
    }
}
...
function pauseCoreOff() {
    switch (1 == audioType ? muted || Howler.unmute() : 2 == audioType && (muted || music.play()), previousTime = (new Date).getTime(), userInput.pauseIsOn = !1, gameState) {
        ...
        case"map":
            ...
            break;
        case"game":
            manualPause = !1, userInput.addHitArea("steerLeft", butEventHandler, {multiTouch: !0}, "rect", {aRect: [0, 60, canvas.width / 2, canvas.height]}, !0), userInput.addHitArea("steerRight", butEventHandler, {multiTouch: !0}, "rect", {aRect: [canvas.width / 2, 60, canvas.width, canvas.height]}, !0), userInput.addKey("steerRight", butEventHandler, null, 39), userInput.addKey("steerLeft", butEventHandler, null, 37), curveTween.resume(), hillTween.resume(), updateGameEvent();
            break;
        case"levelComplete":
            initLevelComplete();
            break;
    ...
    var b = function () {
        ...
        return a.prototype.updateAnimation = function (a) {
            ...
            if (a.save(), a.translate(this.x, this.y), a.rotate(this.rotation), a.scale(this.scaleX, this.scaleY), null != this.animId) {
                var b = this.oAnims[this.animId].length, c = Math.floor(this.frameInc);
                this.curFrame = this.oAnims[this.animId][c % b];
                var d = this.curFrame * this.oImgData.oData.spriteWidth % this.oImgData.img.width, e = Math.floor(this.curFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight;
                if ("once" == this.animType && c > this.maxIdx) {
                    ...
                    var d = this.fixedFrame * this.oImgData.oData.spriteWidth % this.oImgData.img.width, e = Math.floor(this.fixedFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight
                }
            } else var d = this.fixedFrame * this.oImgData.oData.spriteWidth % this.oImgData.img.width, e = Math.floor(this.fixedFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight;
    ...
    var b = function () {
        ...
        return a.prototype.setCanvas = function (a, b, c, d) {
            ...
            if (!this.pauseIsOn) {
                ...
                e - this.prevHitTime < 500 && this.isBugBrowser, this.prevHitTime = e, a.preventDefault(), a.stopPropagation(), b = (b - this.canvasX) * this.canvasScaleX, c = (c - this.canvasY) * this.canvasScaleY;
...
!function (a) {
    var b = function () {
        function a(a, b, c, d, e, f, g, h) {
            this.timer = .3, this.endTime = 0, this.oScoreData = {}, this.posY = 0, this.numberSpace = 30, this.incY = 0, this.highlight = {
                x: 0,
                y: 0
            }, this.aPowerUpBarPos = new Array({x: 63, y: 245}, {x: 233, y: 175}, {x: 403, y: 245}, {
                x: 573,
                y: 175
            }), this.oPanelsImgData = a, this.oUiElementsImgData = b, this.oPositionImgData = c, this.oNumbersImgData = d, this.panelType = e, this.aButs = f, this.canvasWidth = g, this.canvasHeight = h
        }
        ...
        return a.prototype.update = function (a) {
            ...
            this.posY = 550, TweenLite.to(this, .5, {posY: 0, ease: "Quad.easeOut"})
        }, a.prototype.render = function (a, b) {
            switch ("undefined" == typeof b && (b = !0), b || this.addButs(a), this.panelType) {
                case"start":
                    var c = 0, d = c * this.oPanelsImgData.oData.spriteWidth % this.oPanelsImgData.img.width, e = Math.floor(c / (this.oPanelsImgData.img.width / this.oPanelsImgData.oData.spriteWidth)) * this.oPanelsImgData.oData.spriteHeight;
                    ...
                    break;
                case"credits":
                    var c = 4, d = c * this.oPanelsImgData.oData.spriteWidth % this.oPanelsImgData.img.width, e = Math.floor(c / (this.oPanelsImgData.img.width / this.oPanelsImgData.oData.spriteWidth)) * this.oPanelsImgData.oData.spriteHeight;
                    ...
                    break;
                case"levelComplete":
                    var c = 2, d = c * this.oPanelsImgData.oData.spriteWidth % this.oPanelsImgData.img.width, e = Math.floor(c / (this.oPanelsImgData.img.width / this.oPanelsImgData.oData.spriteWidth)) * this.oPanelsImgData.oData.spriteHeight;
                    a.drawImage(this.oPanelsImgData.img, d, e + 1, this.oPanelsImgData.oData.spriteWidth, this.oPanelsImgData.oData.spriteHeight - 2, 0, 0 + this.posY, this.oPanelsImgData.oData.spriteWidth, this.oPanelsImgData.oData.spriteHeight), c = this.oScoreData.racePos;
                    var d = c * this.oPositionImgData.oData.spriteWidth % this.oPositionImgData.img.width, e = Math.floor(c / (this.oPositionImgData.img.width / this.oPositionImgData.oData.spriteWidth)) * this.oPositionImgData.oData.spriteHeight;
                    ...
                    for (var f = this.oScoreData.winnings, g = 0; g < f.toString().length; g++) {
                        ...
                        var d = c * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width, e = Math.floor(c / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                    ...
                    break;
                case"upgrade":
                    var c = 3, d = c * this.oPanelsImgData.oData.spriteWidth % this.oPanelsImgData.img.width, e = Math.floor(c / (this.oPanelsImgData.img.width / this.oPanelsImgData.oData.spriteWidth)) * this.oPanelsImgData.oData.spriteHeight;
                    a.drawImage(this.oPanelsImgData.img, d, e + 1, this.oPanelsImgData.oData.spriteWidth, this.oPanelsImgData.oData.spriteHeight - 2, 0, 0 + this.posY, this.oPanelsImgData.oData.spriteWidth, this.oPanelsImgData.oData.spriteHeight);
                    for (var f = this.oScoreData.winnings, g = 0; g < f.toString().length; g++) {
                        c = parseFloat(f.toString().charAt(g));
                        var d = c * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width, e = Math.floor(c / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
                    ...
                    for (var g = 0; g < this.oScoreData.aPowerUpBarData.length; g++) {
                        ...
                        var h = this.oUiElementsImgData.oData.oAtlasData["upgrade" + c].x, i = this.oUiElementsImgData.oData.oAtlasData["upgrade" + c].y, j = this.oUiElementsImgData.oData.oAtlasData["upgrade" + c].width, k = this.oUiElementsImgData.oData.oAtlasData["upgrade" + c].height;
                        a.drawImage(this.oUiElementsImgData.img, h, i, j, k, this.aPowerUpBarPos[g].x - j / 2, this.aPowerUpBarPos[g].y - k / 2 + this.posY, j, k)
                    }
                    break;
                case"map":
                    var c = 1, d = c * this.oPanelsImgData.oData.spriteWidth % this.oPanelsImgData.img.width, e = Math.floor(c / (this.oPanelsImgData.img.width / this.oPanelsImgData.oData.spriteWidth)) * this.oPanelsImgData.oData.spriteHeight;
                    a.drawImage(this.oPanelsImgData.img, d, e + 1, this.oPanelsImgData.oData.spriteWidth, this.oPanelsImgData.oData.spriteHeight - 2, 0, 0 + this.posY, this.oPanelsImgData.oData.spriteWidth, this.oPanelsImgData.oData.spriteHeight);
                    for (var f = this.oScoreData.totalScore, g = 0; g < f.toString().length; g++) {
                        c = parseFloat(f.toString().charAt(g));
                        var d = c * this.oNumbersImgData.oData.spriteWidth % this.oNumbersImgData.img.width, e = Math.floor(c / (this.oNumbersImgData.img.width / this.oNumbersImgData.oData.spriteWidth)) * this.oNumbersImgData.oData.spriteHeight;
            ...
            for (var b = 0; b < this.aButs.length; b++) {
                ...
                var e = this.aButs[b].oImgData.oData.oAtlasData[this.aButs[b].id].x, f = this.aButs[b].oImgData.oData.oAtlasData[this.aButs[b].id].y, g = this.aButs[b].oImgData.oData.oAtlasData[this.aButs[b].id].width, h = this.aButs[b].oImgData.oData.oAtlasData[this.aButs[b].id].height;
            ...
            if ("map" == this.panelType) {
                for (var i, b = 0; b < aMapPointData.length; b++)
                    if (2 == saveDataHandler.aLevelStore[3 * b]) {
                        ...
                        var j = i * this.oPositionImgData.oData.spriteWidth % this.oPositionImgData.img.width, k = Math.floor(i / (this.oPositionImgData.img.width / this.oPositionImgData.oData.spriteWidth)) * this.oPositionImgData.oData.spriteHeight;
                ...
                a.save(), a.translate(this.highlight.x - 2 + c, this.highlight.y - 2.5 - d), a.globalAlpha = Math.abs(Math.sin(this.incY / 1.5));
                var e = this.oUiElementsImgData.oData.oAtlasData.levelHighlight.x, f = this.oUiElementsImgData.oData.oAtlasData.levelHighlight.y, g = this.oUiElementsImgData.oData.oAtlasData.levelHighlight.width, h = this.oUiElementsImgData.oData.oAtlasData.levelHighlight.height;
...
!function (a) {
    var b = function () {
        function a(a, b, c, d, e) {
            this.speed = 0, this.raceProgress = 0, this.oHudImgData = a, this.oUiElementsImgData = b, this.oPositionImgData = c, this.canvasWidth = d, this.canvasHeight = e
        }

        return a.prototype.render = function (a) {
            nitroMode ? a.drawImage(this.oHudImgData.img, 0, this.oHudImgData.oData.spriteHeight, this.oHudImgData.oData.spriteWidth, this.oHudImgData.oData.spriteHeight, 0, 0, this.oHudImgData.oData.spriteWidth, this.oHudImgData.oData.spriteHeight) : a.drawImage(this.oHudImgData.img, 0, 0, this.oHudImgData.oData.spriteWidth, this.oHudImgData.oData.spriteHeight, 0, 0, this.oHudImgData.oData.spriteWidth, this.oHudImgData.oData.spriteHeight), a.save(), a.translate(71, 69), a.rotate(speed / 95 - 2.5);
            var b = this.oUiElementsImgData.oData.oAtlasData.needle.x, c = this.oUiElementsImgData.oData.oAtlasData.needle.y, d = this.oUiElementsImgData.oData.oAtlasData.needle.width, e = this.oUiElementsImgData.oData.oAtlasData.needle.height;
            a.drawImage(this.oUiElementsImgData.img, b, c, d, e, -d + 10, -e / 2, d, e), a.restore();
            var b = this.oUiElementsImgData.oData.oAtlasData.helmet.x, c = this.oUiElementsImgData.oData.oAtlasData.helmet.y, d = this.oUiElementsImgData.oData.oAtlasData.helmet.width, e = this.oUiElementsImgData.oData.oAtlasData.helmet.height;
            a.drawImage(this.oUiElementsImgData.img, b, c, d, e, 228 + 167 * this.raceProgress - d / 2, 30 - e / 2, d, e);
            var f = racePos * this.oPositionImgData.oData.spriteWidth % this.oPositionImgData.img.width, g = Math.floor(racePos / (this.oPositionImgData.img.width / this.oPositionImgData.oData.spriteWidth)) * this.oPositionImgData.oData.spriteHeight;
...
!function (a) {
    var b = function () {
        function b(a, b, c, d, e, f, g, h, i) {
            this.segNum = 400, this.minWidth = 100, this.maxWidth = 900, this.steerX = 0, this.horizon = 200, this.scrollY = 0, this.scrollX = 0, this.hillAmount = 0, this.curveAmount = 0, this.aScenery = new Array, this.aEnemyCars = new Array, this.sceneryInc = 0, this.enemyInc = 0, this.nitroInc = 0, this.aRowData = new Array, this.sceneryDir = 0, this.enemyIncTarg = 1e3 * Math.random() + 500, this.nitro = null, this.bridgeRow = 0, this.bridgeType = 3, this.carSpace = 100 * Math.random() + 50, this.roadScaleMultiplier = 1, this.oSkylineImgData = a, this.oFogImgData = b, this.oRoadImgData = c, this.oGroundImgData = d, this.levelTheme = e, this.levelNum = f, this.canvasWidth = g, this.canvasHeight = h, "city" == this.levelTheme ? this.roadScaleMultiplier = 1.176 : "desert" == this.levelTheme && (this.roadScaleMultiplier = 1.429), this.callback = i;
            for (var j = 0; j < this.segNum; j++)this.aRowData.push({y: 0, scale: 0});
        ...
        return b.prototype.addNitro = function () {
            this.nitro = new a.Nitro(assetLib.getData("scenery"), "nitro", canvas.width, canvas.height), this.nitro.y = this.horizon + 100 * this.hillAmount
            ...
            var c;
            c = new a.EnemyCar(assetLib.getData("enemyCar"), canvas.width, canvas.height), b || (c.rowNum = this.segNum - 1, c.driftInc = this.steerX < 0 ? 30 : -30, c.driftPower = 1e3), this.carSpace = 100 * Math.random() + 50, this.aEnemyCars.push(c)
        }, b.prototype.update = function (a, b, c, d, e) {
            this.steerX += b * e, this.speed = a, this.delta = e, this.sceneryInc += this.speed * this.delta, this.sceneryInc > 5 && (this.sceneryInc = 0, this.addScenery()), nitroMode ? this.nitroInc = 0 : this.nitroInc += this.speed * this.delta, this.nitroInc > 5e3 && (this.nitroInc = 0, this.addNitro()), this.steerX > 600 / this.roadScaleMultiplier ? (this.steerX = 600 / this.roadScaleMultiplier, nitroMode = !1) : this.steerX < -600 / this.roadScaleMultiplier && (this.steerX = -600 / this.roadScaleMultiplier, nitroMode = !1), this.scrollY -= a * e, this.scrollY < 0 && (this.scrollY += 500), this.hillAmount = d, this.curveAmount = c, this.scrollX += this.curveAmount * (a / 1.5) * e, this.scrollX < 0 && (this.scrollX += 700)
            ...
            a.drawImage(this.oSkylineImgData.img, this.scrollX % this.canvasWidth, 0, this.canvasWidth, this.canvasHeight, 0, 130 * this.hillAmount - 120, this.canvasWidth, this.canvasHeight), a.drawImage(this.oGroundImgData.img, 0, 0, this.canvasWidth, this.canvasHeight, 0, this.horizon + 100 * this.hillAmount, this.canvasWidth, this.canvasHeight);
            for (var b = 500 / this.segNum, c = 0, d = 0; d < this.segNum; d++)this.tempInc = d, this.easeInc = 1 * (this.tempInc /= this.segNum) * this.tempInc * this.tempInc * this.tempInc * this.tempInc * this.tempInc + 0, this.nextRow = d + 1, this.segHeightAfter = 1 * (this.nextRow /= this.segNum) * this.nextRow * this.nextRow * this.nextRow * this.nextRow * this.nextRow + 0 - this.easeInc, this.curve = 1.5 * (this.segNum - d) * this.curveAmount, this.aRowData[d].x = this.steerX * this.easeInc + this.canvasWidth / 2 - 2 * (this.easeInc + this.segHeightAfter) * this.oRoadImgData.oData.spriteWidth / 2 + this.curve - 10 * (this.hillAmount + 1) - 5, this.aRowData[d].y = this.horizon + 100 * this.hillAmount + this.easeInc * (250 + -100 * this.hillAmount), this.aRowData[d].scale = 2 * (this.easeInc + this.segHeightAfter) * this.oRoadImgData.oData.spriteWidth + 30, 0 == c && (this.rowId = d), c += this.segHeightAfter * (250 + -100 * this.hillAmount), c > 1 && (a.drawImage(this.oRoadImgData.img, 0, this.rowId * b + this.scrollY, this.oRoadImgData.oData.spriteWidth, b, this.aRowData[this.rowId].x, this.aRowData[this.rowId].y, this.aRowData[this.rowId].scale, c + 1), c = 0);
            ...
            for (var d = this.aEnemyCars.length - 1; d >= 0; d--)this.aEnemyCars[d].x = this.aRowData[Math.floor(this.aEnemyCars[d].rowNum)].x + this.aRowData[Math.floor(this.aEnemyCars[d].rowNum)].scale * this.aEnemyCars[d].sideMultiplier, this.aEnemyCars[d].y = this.aRowData[Math.floor(this.aEnemyCars[d].rowNum)].y, this.aEnemyCars[d].scale = ((this.aRowData[Math.floor(this.aEnemyCars[d].rowNum)].scale - 30) * this.roadScaleMultiplier + 30) / 780, this.aEnemyCars[d].update(this.steerX, this.curveAmount, this.hillAmount, this.delta), this.aEnemyCars[d].render(a), this.aEnemyCars[d].rowNum += .6 * (this.speed - this.aEnemyCars[d].speed) * this.delta, this.aEnemyCars[d].y > 345 + 20 * this.hillAmount && this.aEnemyCars[d].x < this.canvasWidth / 2 + 80 && this.aEnemyCars[d].x > this.canvasWidth / 2 - 80 ? this.aEnemyCars[d].canHit && (this.aEnemyCars[d].canHit = !1, this.aEnemyCars[d].y > 380 + 20 * this.hillAmount && (this.aEnemyCars[d].speed = 0), this.callback("hitEnemyCar", {bounceX: 1 / 75 * (this.aEnemyCars[d].x - this.canvasWidth / 2)})) : this.aEnemyCars[d].canHit = !0, this.aEnemyCars[d].rowNum >= this.segNum ? (this.aEnemyCars.splice(d, 1), 4 >= startTimer && (racePos--, playSound("overtake"))) : this.aEnemyCars[d].rowNum < 0 && (this.aEnemyCars.splice(d, 1), carReleasedNum++);
            ...
            for (var d = this.aScenery.length - 1; d >= 0; d--)this.aScenery[d].x = this.aRowData[Math.floor(this.aScenery[d].rowNum)].x + this.aRowData[Math.floor(this.aScenery[d].rowNum)].scale * this.aScenery[d].sideMultiplier, this.aScenery[d].y = this.aRowData[Math.floor(this.aScenery[d].rowNum)].y, this.aScenery[d].scale = ((this.aRowData[Math.floor(this.aScenery[d].rowNum)].scale - 30) * this.roadScaleMultiplier + 30 - 10) / 450, this.aScenery[d].render(a), this.aScenery[d].rowNum += .8 * this.speed * this.delta, this.aScenery[d].rowNum >= this.segNum && this.aScenery.splice(d, 1)
        }, b
    }();
    a.Road = b
}(Elements || (Elements = {}));
...
!function (a) {
    var b = function () {
        function a(a, b, c) {
            this.offsetX = 0, this.offsetY = 0, this.canHit = !0, this.driftInc = 100 * Math.random(), this.driftPower = 3 * Math.random() + 1, this.colour = Math.floor(4 * Math.random()), this.oCarImgData = a, this.canvasWidth = b, this.canvasHeight = c, this.scale = .01, this.rowNum = 0, this.speed = enemySpeed
        }

        return a.prototype.update = function (a, b, c, d) {
            this.offsetY = -8 * c * this.scale, this.offsetX = (a + 1200 * (this.sideMultiplier - .5)) / 20 + -15 * b, this.driftInc += d / this.driftPower, this.sideMultiplier = .2 * (Math.sin(this.driftInc) + 1) + .3
        }, a.prototype.render = function (a) {
            var b = this.colour * this.oCarImgData.oData.spriteWidth % this.oCarImgData.img.width, c = Math.floor(this.colour / (this.oCarImgData.img.width / this.oCarImgData.oData.spriteWidth)) * this.oCarImgData.oData.spriteHeight;
            ...
            var b = (this.colour + 4) * this.oCarImgData.oData.spriteWidth % this.oCarImgData.img.width, c = Math.floor((this.colour + 4) / (this.oCarImgData.img.width / this.oCarImgData.oData.spriteWidth)) * this.oCarImgData.oData.spriteHeight;
            ...
            var b = (this.colour + 8) * this.oCarImgData.oData.spriteWidth % this.oCarImgData.img.width, c = Math.floor((this.colour + 8) / (this.oCarImgData.img.width / this.oCarImgData.oData.spriteWidth)) * this.oCarImgData.oData.spriteHeight;
...
!function (a) {
    var b = function () {
        function a(a, b, c, d, e) {
            this.oImgData = a, this.canvasWidth = d, this.canvasHeight = e, this.sideMultiplier = 0 == c ? .8 * -Math.random() - .15 : 1 == c ? .8 * Math.random() + 1.15 : .5, this.id = b, this.scale = .01, this.rowNum = 0
        }

        return a.prototype.render = function (a) {
            var b = this.oImgData.oData.oAtlasData[this.id].x, c = this.oImgData.oData.oAtlasData[this.id].y, d = this.oImgData.oData.oAtlasData[this.id].width, e = this.oImgData.oData.oAtlasData[this.id].height;
...
!function (a) {
    var b = function () {
        function a(a, b, c, d) {
            this.speed = 300, this.oImgData = a, this.canvasWidth = c, this.canvasHeight = d, this.id = b, this.sideMultiplier = .7 * Math.random() + .15, this.scale = .01, this.rowNum = 0
        }
...
!function (a) {
    var b = function () {
        ...
        return a.prototype.clearData = function () {
            ...
            for (var a = 0; a < this.totalLevels - 1; a++)this.aLevelStore.push(0), this.aLevelStore.push(20), this.aLevelStore.push(0);
...
}), music = new Howl({urls: ["audio/music.ogg", "audio/music.m4a"], volume: .2, loop: !0}));
